...
//find a way to connect to metamask on mobile devices
// const getEthereum = () => {
//   if (window.ethereum) {
...
export const TransactionsProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (ethereum) {
      ...
      setTransactionsContract(contract);
    } else {
  ...
  }, [transactionCount, transactionsContract]);
  ...
  const getAllTransactions = async () => {
    try {
      if (ethereum && transactionsContract) {
